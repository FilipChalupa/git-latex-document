...
Pro větší projekty psané v JavaScriptu je běžné využití některého z nástrojů pro správu kódu, jeho strukturu, rozšíření. Typickými zástupci jsou Gulp\footnote{\url{http://gulpjs.com/}}, Grunt\footnote{\url{https://gruntjs.com/}} a Webpack\footnote{\url{https://webpack.github.io/}}. Vzhledem k velké popularitě a podpoře Reactu byla Aplikace vyvýjena pomocí Webpacku, což umožňovalo například zjednodušenou syntaxy JSX\footnote{\url{https://facebook.github.io/react/docs/introducing-jsx.html}}, která významně zpřehledňuje zápisy šablon pro React\footnote{\url{https://facebook.github.io/react/}}, jež se více podobají zápisu v HTML.
