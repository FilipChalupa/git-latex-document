...
% @TODO: https://www.openssh.com/
NodeGit nepodporuje správce klíčů OpenSSH na Windows. Je tedy nutné doinstalovat alternativu Pageant. Navíc je o neběžícím agentu uživatele složité informovat, protože NodeGit tento stav nerozlišuje a poskytuje stejná data i v případě, že Pageant běží, ale pro konkrétní server neposkytuje klíče.

\subsection{cURL}

% @TODO: https://curl.haxx.se/libcurl/
Během vývoje došlo k několika chybám na linuxové platformě týkající se chyby libcurl. Zatím se problém neopakuje. Každopádně závislost NodeGitu na správné konfiguraci platformy je kritická a nevylučuje se, že podobné selhání mohou nastat znovu.
